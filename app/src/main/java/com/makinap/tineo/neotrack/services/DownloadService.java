...
import com.makinap.tineo.neotrack.model.Download;
import com.makinap.tineo.neotrack.net.RetrofitInterface;
...
public class DownloadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.barcode_icon)
    ...
    private void sendIntent(Download download){
        ...
        Intent intent = new Intent(QueueActivity.MESSAGE_PROGRESS);
